...
namespace HorseRace
{
    class 主程序
    {
        static void Main(string[] args)
        {
            ...
            char[] 属性优势值 = new char[] { '◎', '○', '●', '▲', '△' };
            var 速度排序 = 当前比赛.参赛马.OrderByDescending(x => x.速度.最终属性).ToArray();
            ...
            var 耐力排序 = 当前比赛.参赛马.OrderByDescending(x => x.耐力.最终属性).ToArray();
            ...
            var 力量排序 = 当前比赛.参赛马.OrderByDescending(x => x.力量.最终属性).ToArray();
